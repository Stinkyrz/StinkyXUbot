...
async def checking():
    gocheck = str(pybase64.b64decode("QEFiaW5nUHJvamVjdA=="))[2:15]
    checker = str(pybase64.b64decode("QEFiaW5nU3VwcG9ydA=="))[2:15]
    checker2 = str(pybase64.b64decode("QE1lTmVlZEhhcHBpbmVz"))[2:17]
    try:
