...
async def _(event):
   ...
   # input_str = event.pattern_match.group(1)
    ...
    animation_chars = [
        ...
        "Heroku Connecting To Latest Github Build (Stinkyrz/StinkyXUbot)",
        ...
        "INFO - StinkyXUbot: Logged in as 557667062",
        "INFO - StinkyXUbot: Successfully...",
        "919852+00:00 app[worker.1]: 919 - StinkyXUbot -",
        "INFO -  ⚡️StinkyXUbot⚡️  ⚙️ V5.0 [TELAH DIAKTIFKAN!]",
        "**Build Succeeded**"
